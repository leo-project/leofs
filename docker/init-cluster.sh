#!/bin/bash
#======================================================================
# LeoFS Docker Cluster Initialization Script
#======================================================================
set -e
...
echo "=========================================="
echo ""
echo "S3 API Endpoint: http://localhost:28080"
echo "Manager CUI:     localhost:20010"
echo ""
echo "To create a user:"
echo "  $LEOFS_ADM -p 20010 create-user <user-id>"
echo ""
echo "To add a bucket:"
echo "  $LEOFS_ADM -p 20010 add-bucket <bucket-name> <access-key-id>"
echo ""
