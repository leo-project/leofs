...
| `http.ssl_certfile`                       | SSL Certificate file <p>*( Default: ./etc/server\_cert.pem )*</p> |
| `http.ssl_keyfile`                        | SSL key file <p>*( Default: ./etc/server\_key.pem )*</p> |
...
| `log.member_di`r                         | Destination of log file(s) of members of storage-cluster<p>*( Default: ./log/ring )*</p> |
...
| `snmp_agent`                             | Directory of SNMP agent configuration<p>*( Default: ./snmp/snmpa\_gateway\_0/LEO-GATEWAY )*</p> |
